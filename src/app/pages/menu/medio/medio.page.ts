...
export class MedioPage implements OnInit, OnDestroy {
  totalPairs: number = 5;
  images: string[] = [
    '../../assets/medio/alicate.png',
    '../../assets/medio/martillo.png',
    '../../assets/medio/pala.png',
    '../../assets/medio/serrucho.png',
    '../../assets/medio/taladro.png',
  ];
  ...
  segTotales: number = 0;
  audio = new Audio();
  rutaAudio = '../../assets/sounds/medio.mp3';
      ...
      if (++this.currentMove === 2) {
        ...
        if (this.selectedCards[0].image === this.selectedCards[1].image) {
          ...
          if (this.pairsFound === this.totalPairs) {
            ...
            this.playAudioForDuration(this.audioWin, 1000);
